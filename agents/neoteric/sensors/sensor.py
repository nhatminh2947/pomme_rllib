...
from agents.neoteric.enums import SensorType, Board, Direction
...
class Sensor:
    ...
    def _slide(self, board, curr_pos, direction, radius_val, marked_val, flares):
        if curr_pos[0] < 0. or curr_pos[1] < 0. or curr_pos[0] >= BOARD_SIZE or curr_pos[
            1] >= BOARD_SIZE:  # OUT OF BOUNDS
            return
    ...
    @abstractmethod
    def sense(self, obs, recall_board=None):
        pass
