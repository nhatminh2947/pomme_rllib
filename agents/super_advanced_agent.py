...
import numpy as np
from pommerman import constants, utility, envs
from pommerman.agents import BaseAgent


class SuperAdvancedAgent(BaseAgent):
    """This is a baseline agent. After you can beat it, submit your agent to
    compete.
    """

    def __init__(self, *args, **kwargs):
        super(SuperAdvancedAgent, self).__init__(*args, **kwargs)
    ...
    def act(self, obs, action_space):
        ...
        # TODO
        bomb_pred = envs.utils.get_bomb_range(obs)
        board[bomb_pred >= 0.8] = 1
